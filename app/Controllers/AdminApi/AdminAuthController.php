...
final class AdminAuthController extends BaseAdminApiController
{
    ...
    public function login(Request $request, App $app, array $params): \App\Http\Response
    {
        ...
        try {
            ...
            if (($result['user']['id'] ?? null) === null) {
                return ApiResponse::error('LOGIN_FAILED', 'Invalid credentials', 401);
            }
            ...
            if (!in_array('admin', $roles, true)) {
                return ApiResponse::error('FORBIDDEN', 'Admin role required', 403);
            }
